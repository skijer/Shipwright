...
bool CDownItemTex(int item, const char** outName, const char** outPath) {
    switch (item) {
        case ITEM_BOMB:
            *outName = "Sm64CDItem_Bomb";
            *outPath = "textures/icon_item_static/gItemIconBombTex";
            return true;
        case ITEM_BOMBCHU:
            *outName = "Sm64CDItem_Bombchu";
            *outPath = "textures/icon_item_static/gItemIconBombchuTex";
            return true;
        case ITEM_NUT:
            *outName = "Sm64CDItem_Nut";
            *outPath = "textures/icon_item_static/gItemIconDekuNutTex";
            return true;
        case ITEM_OCARINA_FAIRY:
        case ITEM_OCARINA_TIME:
            *outName = "Sm64CDItem_Ocarina";
            *outPath = "textures/icon_item_static/gItemIconOcarinaTimeTex";
            return true;
        default:
            return false;
    }
...
void Sm64CapsHudWindow::Draw() {
    ...
    // framerate-independent.
    {
        ...
        if (sShowTimeLeft > 0.0f) {
            ...
            Player* player =
                (gPlayState != nullptr) ? (Player*)gPlayState->actorCtx.actorLists[ACTORCAT_PLAYER].head : nullptr;
            if (player != nullptr) {
